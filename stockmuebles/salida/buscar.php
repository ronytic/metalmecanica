...
$inventariostock=$stocksalida->mostrarTodoRegistro(" codproducto LIKE '$codproducto' and fechasalida LIKE '$fechasalida'",1,"");
...
<thead>
<tr><th width="50">Nº</th><th>Código</th><th>Nombre</th><th>Unidad</th><th>Cantidad de Salida</th><th>Fecha de Salida</th></tr>
</thead>
<?php
