...
class submenu extends bd{
	...
	function mostrar($Nivel,$Menu){
		...
		switch($Nivel){
			...
			case "3":{return $this->getRecords(" gerente=1 and codmenu=$Menu and activo=1","orden");}break;
			case "4":{return $this->getRecords(" productor=1 and codmenu=$Menu and activo=1","orden");}break;
        }
	}
}
?>