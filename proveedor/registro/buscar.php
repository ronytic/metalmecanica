...
extract($_POST);
$dat=$proveedor->mostrarTodoRegistro(" nombreempresa LIKE '$nombreempresa%' and materiaprima LIKE '$materiaprima%' and referente LIKE '$referente%'",1,"nombreempresa");
?>
<table class="table table-bordered table-striped table-hover">
<thead>
<tr><th width="50">Nº</th><th>Nombre Empresa</th><th>Dirección</th><th>Teléfono</th><th>Materia Prima</th><th>Referente</th></tr>
</thead>
<?php
foreach($dat as $d){$i++;
